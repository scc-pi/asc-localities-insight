...
output: 
  flexdashboard::flex_dashboard:
    theme: paper
    logo: resources/scc-60px.png
    navbar:
      - { title: "ASC SNA", href: "file:///S:/BI%20Team/ASC-SNA/_site/index.html", align: right }      
...
library(boundsheff) # https://github.com/scc-pi/boundsheff
...
for (menu_theme in df_themes$theme) {
  ...
  for (measure_item in df_asc_sli_measures_theme$measure) {
    ...
    out = c(out, knitr::knit_child('_asc_sli_subpage.Rmd',
                                   envir = subpage_env))
  }
}
```
